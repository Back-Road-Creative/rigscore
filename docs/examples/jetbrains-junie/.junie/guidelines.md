# Junie guidelines — rigscore starter template

Starter governance file for JetBrains Junie, calibrated to score well under
rigscore's default profile. Junie reads project rules from
`.junie/guidelines.md`; drop this at that path and adjust paths, gates, and
commands to match your project.
