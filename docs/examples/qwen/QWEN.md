# QWEN.md — rigscore starter template

Starter governance file for Qwen Code, calibrated to score well under
rigscore's default profile. Qwen Code reads `QWEN.md` for hierarchical
context (`context.fileName`); drop this at the repo root and adjust paths,
gates, and commands to match your project.
