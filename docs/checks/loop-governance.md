...
**Enforcement grade:** `pattern` — regex/structural detection over shell scripts, and over the Python and JS modules they call. It reads what is written, not what runs; it follows a call **up to three hops** and no further.
