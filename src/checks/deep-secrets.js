...
const PATTERN_LABEL_RULES = [
  ...
  ['gh[usr]_', 'GitHub token (user/server/refresh)'], ['github_pat_', 'GitHub fine-grained PAT'],
  ['xoxb-', 'Slack bot token'], ['xoxp-', 'Slack user token'], ['xox[aers]-', 'Slack token'],
  ['sk-(?:proj', 'OpenAI API key'], ['sk-[a-zA-Z0-9]{48}', 'OpenAI API key (legacy)'],
  ['GOCSPX-', 'Google OAuth client secret'], ['glpat-', 'GitLab personal access token'],
  ...
  ['shp(?:at', 'Shopify access token'], ['dapi[0-9a-f]', 'Databricks personal access token'],
