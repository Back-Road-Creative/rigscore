...
const CONSTRAINT_CHECKS = [
  ...
  },
  {
    ...
    finding: {
      ...
      detail: 'Governance requires reading existing files before overwriting in projects/svc-* (untracked files have no backup), but this skill performs write operations without mentioning the precaution.',
      remediation: 'Add WIP protection note: "Before overwriting files in projects/svc-*, read them first — untracked files have no backup."',
    },
  },
  {
